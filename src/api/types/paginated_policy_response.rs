...
pub struct PaginatedPolicyResponse {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub aggregates: Option<PolicyAggregates>,
}

impl PaginatedPolicyResponse {
    pub fn builder() -> PaginatedPolicyResponseBuilder {
        <PaginatedPolicyResponseBuilder as Default>::default()
    }
}

#[derive(Clone, PartialEq, Default, Debug)]
#[non_exhaustive]
pub struct PaginatedPolicyResponseBuilder {
    current_page: Option<i64>,
    data: Option<Vec<Policy>>,
    ...
    to: Option<i64>,
    total: Option<i64>,
    aggregates: Option<PolicyAggregates>,
}

impl PaginatedPolicyResponseBuilder {
    pub fn current_page(mut self, value: i64) -> Self {
        self.current_page = Some(value);
        self
    }

    pub fn data(mut self, value: Vec<Policy>) -> Self {
    ...
    pub fn aggregates(mut self, value: PolicyAggregates) -> Self {
        self.aggregates = Some(value);
        self
    }

    /// Consumes the builder and constructs a [`PaginatedPolicyResponse`].
    pub fn build(self) -> Result<PaginatedPolicyResponse, BuildError> {
        Ok(PaginatedPolicyResponse {
